...
public class CityManager : MonoBehaviour
{
     ...
     **/
    public GameObject CreateCity(Vector2Int coords, Faction playerFaction)
    {
        GameObject city = (GameObject) Instantiate(Resources.Load("Prefabs/City"), new Vector3(0, 0, 0), Quaternion.identity, null);
        city.GetComponent<City>().Setup(playerFaction, coords, GameBoardManager.Instance.GetTile(coords), true);
        selectedCity = city;
